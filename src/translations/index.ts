...
export const translations: Record<SupportedLanguage, TranslationKeys> = {
  ...
  es: {
    ...
    product: {
      ...
      cancel: "Cancelar",
      confirm: "Confirmar",
      nameRequired: "Nombre y teléfono son requeridos",
    },
    catalog: {
  ...
  fr: {
    ...
    product: {
      ...
      cancel: "Annuler",
      confirm: "Confirmer",
      nameRequired: "Nom et téléphone sont requis",
    },
    catalog: {
  ...
  de: {
    ...
    product: {
      ...
      cancel: "Abbrechen",
      confirm: "Bestätigen",
      nameRequired: "Name und Telefon sind erforderlich",
    },
    catalog: {
  ...
  it: {
    ...
    product: {
      ...
      cancel: "Annulla",
      confirm: "Conferma",
      nameRequired: "Nome e telefono sono richiesti",
    },
    catalog: {
